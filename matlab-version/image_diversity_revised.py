...
class ImageWindow:
    ...
    def onOpen(self):
        '''self.top = Tkinter.Tk()
        self.label = Tkinter.Label(self.top, text = 'image_diversity file chooser')
        self.label.pack()
        self.top.title("Open Image Files")
        '''
        self.datafiles = tkFileDialog.askopenfilenames(initialdir="/home/",
